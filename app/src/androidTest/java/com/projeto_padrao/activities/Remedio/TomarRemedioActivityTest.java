...
public class TomarRemedioActivityTest {

    @Rule
    public ActivityTestRule<StartActivity> mActivityTestRule = new ActivityTestRule<>(StartActivity.class);

    @Test
    public void tomarRemedioActivityTest() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.recomendacao_lista_button_tomar), withText("Tomar"),
                        childAtPosition(
                                withParent(withId(R.id.recomendacao_lista_listview)),
                                4),
                        isDisplayed()));
