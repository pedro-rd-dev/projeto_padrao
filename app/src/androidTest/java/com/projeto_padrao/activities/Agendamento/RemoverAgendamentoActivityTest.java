...
public class RemoverAgendamentoActivityTest {

    @Rule
    public ActivityTestRule<StartActivity> mActivityTestRule = new ActivityTestRule<>(StartActivity.class);

    @Test
    public void removerAgendamentoActivityTest() {
        ...
        ViewInteraction view2 = onView(
                allOf(withId(R.id.meus_item_view),
                        childAtPosition(
                                withParent(withId(R.id.agend_lista_user)),
                                0),
                        isDisplayed()));
        view2.perform(click());
